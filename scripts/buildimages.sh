...
echo 'building image simple-pcf-application-buildstage'
cd source
${CONTAINER_RUNTIME} build -f Dockerfile.buildstage -t simple-pcf-application-buildstage .
cd -

echo 'building image simple-pcf-application'
cd source
${CONTAINER_RUNTIME} build -f Dockerfile -t simple-pcf-application .
cd -
