...
echo "pushing image simple-pcf-application"
%CONTAINER_RUNTIME% tag simple-pcf-application %REGISTRY_URL%/%REGISTRY_NAMESPACE%/simple-pcf-application
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/simple-pcf-application

echo "pushing image simple-pcf-application-buildstage"
%CONTAINER_RUNTIME% tag simple-pcf-application-buildstage %REGISTRY_URL%/%REGISTRY_NAMESPACE%/simple-pcf-application-buildstage
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/simple-pcf-application-buildstage
